...
- (id)initWithCoder:(NSCoder*)decoder
{
    ...
    [self setWriteValue:	[decoder decodeIntegerForKey:		@"ORMTCModelWriteValue"]];
    [self setMemoryOffset:	[decoder decodeIntegerForKey:		@"ORMTCModelMemoryOffset"]];
    ...
    [self setMtcaN100Mask:[decoder decodeIntegerForKey:@"mtcaN100Mask"]];
    [self setMtcaN20Mask:[decoder decodeIntegerForKey:@"mtcaN20Mask"]];
    [self setMtcaEHIMask:[decoder decodeIntegerForKey:@"mtcaEHIMask"]];
    [self setMtcaELOMask:[decoder decodeIntegerForKey:@"mtcaELOMask"]];
    [self setMtcaOELOMask:[decoder decodeIntegerForKey:@"mtcaOELOMask"]];
    [self setMtcaOEHIMask:[decoder decodeIntegerForKey:@"mtcaOEHIMask"]];
    [self setMtcaOWLNMask:[decoder decodeIntegerForKey:@"mtcaOWLNMask"]];
...
- (void)encodeWithCoder:(NSCoder*)encoder
{
	...
	[encoder encodeInteger:writeValue		forKey:@"ORMTCModelWriteValue"];
	[encoder encodeInteger:memoryOffset	forKey:@"ORMTCModelMemoryOffset"];
    ...
    [encoder encodeInteger:(int32_t)[self mtcaN100Mask] forKey:@"mtcaN100Mask"];
    [encoder encodeInteger:(int32_t)[self mtcaN20Mask] forKey:@"mtcaN20Mask"];
    [encoder encodeInteger:(int32_t)[self mtcaEHIMask] forKey:@"mtcaEHIMask"];
    [encoder encodeInteger:(int32_t)[self mtcaELOMask] forKey:@"mtcaELOMask"];
    [encoder encodeInteger:(int32_t)[self mtcaOELOMask] forKey:@"mtcaOELOMask"];
    [encoder encodeInteger:(int32_t)[self mtcaOEHIMask] forKey:@"mtcaOEHIMask"];
    [encoder encodeInteger:(int32_t)[self mtcaOWLNMask] forKey:@"mtcaOWLNMask"];

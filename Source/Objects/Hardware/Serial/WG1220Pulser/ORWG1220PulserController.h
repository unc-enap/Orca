...
@interface ORWG1220PulserController : OrcaObjectController
{
	//pusler variables
	...
	IBOutlet NSPopUpButton* signalFormPU;
	  IBOutlet NSButton* loadWaveButton;
		IBOutlet NSButton*      loadAmpButton;
...
- (void) loadWaveAction;
- (IBAction) signalFormAction:(id)sender;

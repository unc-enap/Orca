...
static NSString* setPointList_RS1[] = {
    ...
    @"111-EHV-1-1600-0103", @"Iseg Ramp Set ",
    @"111-EHV-1-1600-0104", @"Iseg Ramp  Abort ",
    @"111-LUV-0-2501-0105", @"Clear Laser Interlock ",
    @"111-AAI-0-3101-0100", @"Egun Plate Angle ",
    @"-", @"200ELV-5-3410-0020 [status] Rampe einschalten / ausschalten1",
    @"-", @"200ELV-5-3410-0021 [status] Polung negativ / positiv1",
    @"-", @"200ELV-5-3420-0022 [status] Rampe einschalten / ausschalten2",
    @"-", @"200ELV-5-3420-0023 [status] Polung negativ / positiv2",
    @"-", @"200ELV-5-3410-0024 [current] Zielsollwert1",
    @"-", @"200ELV-5-3410-0025 [rate] Rampengeschwindigkeit Up1",
    @"-", @"200ELV-5-3410-0026 [rate] Rampengeschwindigkeit Down1",
    @"-", @"200ELV-5-3420-0027 [current] Zielsollwert2",
    @"-", @"200ELV-5-3420-0028 [rate] Rampengeschwindigkeit Up2",
    @"-", @"200ELV-5-3420-0029 [rate] Rampengeschwindigkeit Down2",
    @"", @""
};
...
static NSString* measuredValueList_RS1[] = {
    ...
    @"111-AAI-0-3101-0003", @"Linear Screw Drive End-switches status ",
    @"-", @"200ELV-5-3410-0000 [status] Automatikmodus Rampe1",
    @"-", @"200ELV-5-3410-0001 [status] Automatikmodus Polung1",
    @"-", @"200ELV-5-3410-0002 [status] Rueckmeldung Polung1",
    @"-", @"200ELV-5-3420-0003 [status] Automatikmodus Rampe2",
    @"-", @"200ELV-5-3420-0004 [status] Automatikmodus Polung2",
    @"-", @"200ELV-5-3420-0005 [status] Rueckmeldung Polung2",
    @"-", @"200ELV-5-3410-0006 [current] Zielsollwert1",
    @"-", @"200ELV-5-3410-0007 [rate] Rampengeschwindigkeit Up1",
    @"-", @"200ELV-5-3410-0008 [rate] Rampengeschwindigkeit Down1",
    @"-", @"200ELV-5-3410-0009 [current] Istwert1",
    @"-", @"200ELV-5-3420-00010 [current] Zielsollwert2",
    @"-", @"200ELV-5-3420-00011 [rate] Rampengeschwindigkeit Up2",
    @"-", @"200ELV-5-3420-00012 [rate] Rampengeschwindigkeit Down2",
    @"-", @"200ELV-5-3420-00013 [current] Istwert2",
    @"", @""
};
...
static NSString* measuredValueList_RS2[] = {
    ...
    @"111-AAI-0-2301-0002", @"Translation Stage X status ",
    @"111-AAI-0-2302-0000", @"Translation Stage Y position ",
    @"111-AAI-0-2302-0001", @"Translation Stage Y on position? ",
    @"111-AAI-0-2302-0002", @"Translation Stage Y status ",
    @"111-AAI-0-2303-0000", @"Translation Stage Z position ",
    @"111-AAI-0-2303-0001", @"Translation Stage Z on position? ",
    @"111-AAI-0-2303-0002", @"Translation Stage Z status ",
    @"111-AAI-0-2601-0001", @"Noise Eater Readout ",
    @"111-AAI-0-2601-0002", @"Noise Eater clipped? ",
    @"212-EHV-0-1311-0001", @"Rear wall  Current (spare) ",

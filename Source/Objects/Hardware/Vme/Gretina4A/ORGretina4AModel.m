...
- (id)initWithCoder:(NSCoder*)decoder
{
    ...
    [self setExtDiscriminatorSrc:       [decoder decodeIntegerForKey: @"extDiscriminatorSrc"]];
    [self setExtDiscriminatorMode:      [decoder decodeIntegerForKey: @"extDiscriminatorMode"]];
    [self setUserPackageData:           [decoder decodeIntegerForKey: @"userPackageData"]];
    ...
    [self setChannelPulsedControl:      [decoder decodeIntegerForKey: @"channelPulsedControl"]];
    [self setDiagMuxControl:            [decoder decodeIntegerForKey: @"diagMuxControl"]];
    ...
    [self setRj45SpareIoMuxSel:         [decoder decodeIntegerForKey: @"rj45SpareIoMuxSel"]];
    ...
    [self setTSErrCntCtrl:              [decoder decodeIntegerForKey: @"tSErrCntCtrl"]];
    [self setClkSelect0:                [decoder decodeBoolForKey:  @"clkSelect0"]];
    [self setClkSelect1:                [decoder decodeBoolForKey:  @"clkSelect1"]];
    [self setAuxIoRead:                 [decoder decodeIntegerForKey: @"auxIoRead"]];
    [self setAuxIoWrite:                [decoder decodeIntegerForKey: @"auxIoWrite"]];
    [self setAuxIoConfig:               [decoder decodeIntegerForKey: @"auxIoConfig"]];
...
- (void)encodeWithCoder:(NSCoder*)encoder
{
    ...
    [encoder encodeInteger:extDiscriminatorSrc        forKey:@"extDiscriminatorMode"];
    [encoder encodeInteger:extDiscriminatorMode       forKey:@"extDiscriminatorSrc"];
    [encoder encodeInteger:userPackageData            forKey:@"userPackageData"];
    ...
    [encoder encodeInteger:channelPulsedControl       forKey:@"channelPulsedControl"];
    [encoder encodeInteger:diagMuxControl             forKey:@"diagMuxControl"];
    ...
    [encoder encodeInteger:rj45SpareIoMuxSel          forKey:@"rj45SpareIoMuxSel"];
    ...
    [encoder encodeInteger:tSErrCntCtrl               forKey:@"tSErrCntCtrl"];
    [encoder encodeBool:clkSelect0                  forKey:@"clkSelect0"];
    [encoder encodeBool:clkSelect1                  forKey:@"clkSelect1"];
    [encoder encodeInteger:auxIoRead                  forKey:@"auxIoRead"];
    [encoder encodeInteger:auxIoWrite                 forKey:@"auxIoWrite"];
    [encoder encodeInteger:auxIoConfig                forKey:@"auxIoConfig"];

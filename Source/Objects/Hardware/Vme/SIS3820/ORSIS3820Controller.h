...
@interface ORSIS3820Controller : OrcaObjectController 
{
	...
	IBOutlet NSButton*		invertLemoOutButton;
	IBOutlet NSButton*		invertLemoInButton;
	...
	IBOutlet NSButton*		enableCounterTestModeButton;
	IBOutlet NSButton*		enable25MHzPulsesButton;
	IBOutlet NSTextField*	lemoInText;
	IBOutlet NSTextField*	lemoOutText;
...
- (IBAction) invertLemoOutAction:(id)sender;
- (IBAction) invertLemoInAction:(id)sender;

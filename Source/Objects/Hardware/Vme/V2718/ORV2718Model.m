...
- (void) setUpImage
{
    [self setImage:[NSImage imageNamed:@"V2718Card"]];
}

- (void) makeMainController
{
    [self linkToController:@"ORV2718Controller"];
}
...
- (void) resetContrl
{
	...
	if(!controller){
		[NSException raise:@"Not Connected" format:@"You must connect to a PCI Controller."];
	}

...
//no code here, just a special changed notification string that can be 
//used globally by objects that need to update on changes of info.

NSString* ORAdcInfoProvidingValueChanged = @"ORAdcInfoProvidingValueChanged";
...
- (id) initWithCoder:(NSCoder*)decoder
{
	...
	[self setChanY:[decoder decodeIntegerForKey:@"OReGunModelChanY"]];
	[self setChanX:[decoder decodeIntegerForKey:@"OReGunModelChanX"]];
...
- (void) encodeWithCoder:(NSCoder*)encoder
{
    ...
    [encoder encodeInteger:viewType forKey:@"OReGunModelViewType"];
    [encoder encodeFloat:millimetersPerVolt forKey:@"OReGunModelMillimetersPerVolt"];
    [encoder encodeInteger:chanY forKey:@"OReGunModelChanY"];
    [encoder encodeInteger:chanX forKey:@"OReGunModelChanX"];

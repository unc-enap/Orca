...
- (void) awakeFromNib
{
    ...
    NSString* key = [NSString stringWithFormat: @"orca.ORCB37%u.selectedtab",[model uniqueIdNumber]];
...
- (void)tabView:(NSTabView *)aTabView didSelectTabViewItem:(NSTabViewItem *)tabViewItem
{
    ...
    NSString* key = [NSString stringWithFormat: @"orca.ORCB37%u.selectedtab",[[model guardian] uniqueIdNumber]];

...
NSString* OREHS8240nModelOutputFailureBehaviorChanged = @"OREHS8240nModelOutputFailureBehaviorChanged";
NSString* OREHS8240nModelCurrentTripBehaviorChanged = @"OREHS8240nModelCurrentTripBehaviorChanged";
NSString* OREHS8240nModelSupervisorMaskChanged	= @"OREHS8240nModelSupervisorMaskChanged";
NSString* OREHS8240nModelTripTimeChanged		= @"OREHS8240nModelTripTimeChanged";
NSString* OREHS8240nSettingsLock				= @"OREHS8240nSettingsLock";

@interface OREHS8240nModel (private)
- (void) makeRampers;
@end

@implementation OREHS8240nModel

#define kMaxVoltage 4000
#define kMaxCurrent 100
...
{
    [self linkToController:@"OREHS8240nController"];
}

- (NSString*) settingsLock
{
	 return OREHS8240nSettingsLock;
}
...
- (void) setOutputFailureBehavior:(short)chan withValue:(short)aValue
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:OREHS8240nModelOutputFailureBehaviorChanged object:self];
}
...
- (void) setCurrentTripBehavior:(short)chan withValue:(short)aValue
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:OREHS8240nModelCurrentTripBehaviorChanged object:self];
}
...
- (void) setTripTime:(short)chan withValue:(short)aValue 
{
	if([self channelInBounds:chan]){
		...
		[[NSNotificationCenter defaultCenter] postNotificationName:OREHS8240nModelTripTimeChanged object:self];
	}
}
...
- (NSArray*) wizardSelections
{
    ...
    [a addObject:[ORHWWizSelection itemAtLevel:kObjectLevel name:@"Card" className:@"OREHS8240nModel"]];
    [a addObject:[ORHWWizSelection itemAtLevel:kChannelLevel name:@"Channel" className:@"OREHS8240nModel"]];
    return a;
}
...
@implementation OREHS8240nModel (private)
- (void) makeRampers
{
    [[self undoManager] disableUndoRegistration];

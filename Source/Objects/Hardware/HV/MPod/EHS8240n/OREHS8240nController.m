...
#import "OREHS8240nController.h"
#import "OREHS8240nModel.h"
#import "ORDetectorRamper.h"

@implementation OREHS8240nController

-(id)init
{
    self = [super initWithWindowNibName:@"EHS8240n"];
    return self;
}
...
- (void) registerNotificationObservers
{
    ...
    [notifyCenter addObserver : self
                     selector : @selector(tripTimeChanged:)
                         name : OREHS8240nModelTripTimeChanged
						object: model];

    [notifyCenter addObserver : self
                     selector : @selector(currentTripBehaviorChanged:)
                         name : OREHS8240nModelCurrentTripBehaviorChanged
						object: model];

    [notifyCenter addObserver : self
                     selector : @selector(outputFailureBehaviorChanged:)
                         name : OREHS8240nModelOutputFailureBehaviorChanged
						object: model];

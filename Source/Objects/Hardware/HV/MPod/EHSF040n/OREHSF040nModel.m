...
NSString* OREHSF040nModelOutputFailureBehaviorChanged = @"OREHSF040nModelOutputFailureBehaviorChanged";
NSString* OREHSF040nModelCurrentTripBehaviorChanged = @"OREHSF040nModelCurrentTripBehaviorChanged";
NSString* OREHSF040nModelSupervisorMaskChanged	= @"OREHSF040nModelSupervisorMaskChanged";
NSString* OREHSF040nModelTripTimeChanged		= @"OREHSF040nModelTripTimeChanged";
NSString* OREHSF040nSettingsLock				= @"OREHSF040nSettingsLock";

@interface OREHSF040nModel (private)
- (void) makeRampers;
@end

@implementation OREHSF040nModel

#define kMaxVoltage 4000
...
{
    [self linkToController:@"OREHSF040nController"];
}

- (NSString*) settingsLock
{
	 return OREHSF040nSettingsLock;
}
...
- (void) setOutputFailureBehavior:(short)chan withValue:(short)aValue
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:OREHSF040nModelOutputFailureBehaviorChanged object:self];
}
...
- (void) setCurrentTripBehavior:(short)chan withValue:(short)aValue
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:OREHSF040nModelCurrentTripBehaviorChanged object:self];
}
...
- (void) setTripTime:(short)chan withValue:(short)aValue 
{
	if([self channelInBounds:chan]){
		...
		[[NSNotificationCenter defaultCenter] postNotificationName:OREHSF040nModelTripTimeChanged object:self];
	}
}
...
{
    return 16; //default... subclasses can override (max 16)
}
...
- (NSArray*) wizardSelections
{
    ...
    [a addObject:[ORHWWizSelection itemAtLevel:kObjectLevel name:@"Card" className:@"OREHSF040nModel"]];
    [a addObject:[ORHWWizSelection itemAtLevel:kChannelLevel name:@"Channel" className:@"OREHSF040nModel"]];
    return a;
}
...
@implementation OREHSF040nModel (private)
- (void) makeRampers
{
    [[self undoManager] disableUndoRegistration];
	[self setRampers:[NSMutableArray arrayWithCapacity:16]];
	int i;
	for(i=0;i<16;i++){

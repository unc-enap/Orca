...
#import "ORKatrinHgfAmcDecoder.h"
...
@implementation ORKatrinHgfAmcDecoderForEnergy
...
- (uint32_t) decodeData:(void*)someData fromDecoder:(ORDecoder*)aDecoder intoDataSet:(ORDataSet*)aDataSet;
{
	...
	if(getRatesFromDecodeStage || getFifoFlagsFromDecodeStage){
		...
		ORKatrinHgfAmcModel*   obj = [actualFlts objectForKey:fltKey];
		if(!obj){
			NSArray* listOfFlts = [[(ORAppDelegate*)[NSApp delegate] document] collectObjectsOfClass:NSClassFromString(@"ORKatrinHgfAmcModel")];
			for(ORKatrinHgfAmcModel* aFlt in listOfFlts){
...
@implementation ORKatrinHgfAmcDecoderForWaveForm
...
@implementation ORKatrinHgfAmcDecoderForHitRate
...
@implementation ORKatrinHgfAmcDecoderForHistogram

...
@interface ORIpeMtcaCrateModel : ORCrate   {
	BOOL isConnected;
...
extern NSString* ORIpeMtcaCrateModelUnlockedStopButtonChanged;
extern NSString* ORIpeMtcaCrateModelSnmpPowerSupplyIPChanged;
extern NSString* ORIpeMtcaCrateConnectedChanged;

@interface NSObject (ORIpeMtcaCrateModel)

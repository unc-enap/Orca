...
@interface ORKatrinMchModel : ORIpeCard <ORDataTaker,SBC_Linking>
{
	@private
		uint32_t	hwVersion;
...
extern NSString* ORKatrinMchModelPixelBusEnableRegChanged;
extern NSString* ORKatrinMchModelSecondsSetSendToFLTsChanged;
extern NSString* ORKatrinMchModelSecondsSetInitWithHostChanged;
extern NSString* ORKatrinMchModelSltScriptArgumentsChanged;
extern NSString* ORKatrinMchModelCountersEnabledChanged;
extern NSString* ORKatrinMchModelClockTimeChanged;
extern NSString* ORKatrinMchModelRunTimeChanged;
extern NSString* ORKatrinMchModelVetoTimeChanged;
extern NSString* ORKatrinMchModelDeadTimeChanged;
extern NSString* ORKatrinMchModelSecondsSetChanged;
extern NSString* ORKatrinMchModelStatusRegChanged;
extern NSString* ORKatrinMchModelControlRegChanged;
extern NSString* ORKatrinMchModelHwVersionChanged;
extern NSString* ORKatrinMchModelMinimizeDecodingChanged;

extern NSString* ORKatrinMchModelPatternFilePathChanged;
extern NSString* ORKatrinMchModelInterruptMaskChanged;
extern NSString* ORKatrinMchPulserDelayChanged;
extern NSString* ORKatrinMchPulserAmpChanged;
extern NSString* ORKatrinMchSelectedRegIndexChanged;
extern NSString* ORKatrinMchWriteValueChanged;
extern NSString* ORKatrinMchSettingsLock;
extern NSString* ORKatrinMchStatusRegChanged;
extern NSString* ORKatrinMchControlRegChanged;
extern NSString* ORKatrinMchPollTimeChanged;
extern NSString* ORKatrinMchModelReadAllChanged;
extern NSString* ORKatrinMchModelLostEventsChanged;
extern NSString* ORKatrinMchModelLostFltEventsChanged;
extern NSString* ORKatrinMchModelLostFltEventsTrChanged;
extern NSString* ORKatrinMchcpuLock;

...
@class ORKatrinMchRegisters;

#define katrinV4SLTRegisters [ORKatrinMchRegisters sharedRegSet]

static ORKatrinMchRegisters* sharedKatrinV4SLTRegisters;
...
@interface ORKatrinMchRegisters : NSObject
{
    BOOL printedOnce;
}

+ (ORKatrinMchRegisters*) sharedRegSet;
- (id) init;
- (void) dealloc;

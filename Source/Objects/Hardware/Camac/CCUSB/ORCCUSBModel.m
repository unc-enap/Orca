...
- (id)initWithCoder:(NSCoder*)decoder
{
    ...
    [self setDataWord:[decoder decodeIntegerForKey:@"ORCCUSBModelDataWord"]];
    [self setDataModifierBits:[decoder decodeIntegerForKey:@"ORCCUSBModelDataModifierBits"]];
    [self setNafModBits:[decoder decodeIntegerForKey:@"ORCCUSBModelNafModBits"]];
    [self setFValue:[decoder decodeIntegerForKey:@"ORCCUSBModelFValue"]];
    [self setAValue:[decoder decodeIntegerForKey:@"ORCCUSBModelAValue"]];
    [self setNValue:[decoder decodeIntegerForKey:@"ORCCUSBModelNValue"]];
    [self setUsbTransferSetup:[decoder decodeIntegerForKey:@"ORCCUSBModelUsbTransferSetup"]];
    [self setLAMMaskValue:[decoder decodeIntegerForKey:@"ORCCUSBModelLAMMaskValue"]];
    [self setScalerB:[decoder decodeIntegerForKey:@"ORCCUSBModelScalerB"]];
    [self setScalerA:[decoder decodeIntegerForKey:@"ORCCUSBModelScalerA"]];
    [self setDelayAndGateExt:[decoder decodeIntegerForKey:@"ORCCUSBModelDelayAndGateExt"]];
    [self setDelayAndGateB:[decoder decodeIntegerForKey:@"ORCCUSBModelDelayAndGateB"]];
    [self setDelayAndGateA:[decoder decodeIntegerForKey:@"ORCCUSBModelDelayAndGateA"]];
    [self setScalerReadout:[decoder decodeIntegerForKey:@"ORCCUSBModelScalerReadout"]];
    [self setUserDeviceSelector:[decoder decodeIntegerForKey:@"ORCCUSBModelUserDeviceSelector"]];
    [self setUserNIMSelector:[decoder decodeIntegerForKey:@"ORCCUSBModelUserNIMSelector"]];
    [self setUserLEDSelector:[decoder decodeIntegerForKey:@"ORCCUSBModelUserLEDSelector"]];
    [self setDelays:[decoder decodeIntegerForKey:@"ORCCUSBModelDelays"]];
    [self setGlobalMode:[decoder decodeIntegerForKey:@"ORCCUSBModelGlobalMode"]];
...
- (void)encodeWithCoder:(NSCoder*)encoder
{
    ...
    [encoder encodeInteger:dataWord forKey:@"ORCCUSBModelDataWord"];
    [encoder encodeInteger:dataModifierBits forKey:@"ORCCUSBModelDataModifierBits"];
    [encoder encodeInteger:nafModBits forKey:@"ORCCUSBModelNafModBits"];
    [encoder encodeInteger:fValue forKey:@"ORCCUSBModelFValue"];
    [encoder encodeInteger:aValue forKey:@"ORCCUSBModelAValue"];
    [encoder encodeInteger:nValue forKey:@"ORCCUSBModelNValue"];
    [encoder encodeInteger:usbTransferSetup forKey:@"ORCCUSBModelUsbTransferSetup"];
    [encoder encodeInteger:LAMMaskValue forKey:@"ORCCUSBModelLAMMaskValue"];
    [encoder encodeInteger:scalerB forKey:@"ORCCUSBModelScalerB"];
    [encoder encodeInteger:scalerA forKey:@"ORCCUSBModelScalerA"];
    [encoder encodeInteger:delayAndGateExt forKey:@"ORCCUSBModelDelayAndGateExt"];
    [encoder encodeInteger:delayAndGateB forKey:@"ORCCUSBModelDelayAndGateB"];
    [encoder encodeInteger:delayAndGateA forKey:@"ORCCUSBModelDelayAndGateA"];
    [encoder encodeInteger:scalerReadout forKey:@"ORCCUSBModelScalerReadout"];
    [encoder encodeInteger:userDeviceSelector forKey:@"ORCCUSBModelUserDeviceSelector"];
    [encoder encodeInteger:(int32_t)userNIMSelector forKey:@"ORCCUSBModelUserNIMSelector"];
    [encoder encodeInteger:(int32_t)userLEDSelector forKey:@"ORCCUSBModelUserLEDSelector"];
    [encoder encodeInteger:delays forKey:@"ORCCUSBModelDelays"];
    [encoder encodeInteger:globalMode forKey:@"ORCCUSBModelGlobalMode"];
    [encoder encodeInteger:registerValue forKey:@"ORCCUSBModelRegisterValue"];
    [encoder encodeInteger:internalRegSelection forKey:@"ORCCUSBModelInternalRegSelection"];

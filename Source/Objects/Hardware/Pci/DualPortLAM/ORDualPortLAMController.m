...
#import "ORDualPortLAMController.h"
#import "ORDualPortLAMModel.h"
#import "OReCPU147Config.h"

@implementation ORDualPortLAMController

#pragma mark ***Initialization

- (id) init
{
	self = [super initWithWindowNibName:@"DualPortLAM"];
	return self;
}
...
- (void) checkGlobalSecurity
{
    ...
    [gSecurity setLock:ORDualPortLAMLock to:secure];
    [lockButton setEnabled:secure];
}

- (void) lockChanged:(NSNotification*)aNotification
{
    BOOL locked = [gSecurity isLocked:ORDualPortLAMLock];
...
- (void) slotChanged:(NSNotification*)aNotification
{
	...
	[[self window] setTitle:[NSString stringWithFormat:@"DualPort Memory LAM (%d)",[model slot]]];
}
...
{
    [gSecurity tryToSetLock:ORDualPortLAMLock to:[sender intValue] forWindow:[self window]];
}

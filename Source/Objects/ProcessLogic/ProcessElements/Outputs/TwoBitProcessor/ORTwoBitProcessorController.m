...
#import "ORTwoBitProcessorController.h"

@implementation ORTwoBitProcessorController
-(id)init
{
    self = [super initWithWindowNibName:@"TwoBitProcessor"];
    return self;
}
